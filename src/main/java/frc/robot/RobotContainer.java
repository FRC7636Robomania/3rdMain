...
public class RobotContainer {
  ...
  private void teleop(){
    controlDrivetrain.setDefaultCommand(
      new RunCommand(
        ()->controlDrivetrain
                .curvatureDrive(joystick.getY() * 0.2, joystick.getZ() * -0.2 , joystick.getTrigger()), 
          controlDrivetrain)
      );
  }

  private void modeSelector(){
    chooser.addOption("Left Up",          new LeftUp(trajectoryDrivetrain, controlDrivetrain, m_intake, m_conveyor, m_shooter, m_arm, m_wing));
